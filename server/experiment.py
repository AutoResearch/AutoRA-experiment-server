...
#
#         ## Present experiment.
#         return render_template('experiment.html', workerId=session['workerId'], assignmentId=session['assignmentId'],
#                                hitId=session['hitId'], code_success=session['code_success'],
